...
const translations: Record<Language, Translations> = {
  en: {
    ...
    'skill_1_title': '🤖 AI-Driven Data Solutions',
    'skill_1_desc': 'Combining machine learning, analytics, and automation to transform raw data into intelligent systems.',
    'skill_2_title': '⚙️ Machine Learning Engineering',
    'skill_2_desc': 'Designing and deploying scalable ML pipelines, from model training to production-ready endpoints.',
    'skill_3_title': '✨ Generative AI Applications',
    'skill_3_desc': 'Building intelligent assistants with RAG, LLMs, embeddings, and prompt engineering to solve real-world problems.',
    'skill_4_title': '📊 Data Analytics & Visualization',
    'skill_4_desc': 'Transforming complex datasets into clear narratives and actionable insights with modern BI tools.',
    'skill_5_title': '🔮 Predictive Modeling & Forecasting',
    'skill_5_desc': 'Time-series analysis, statistical modeling, and algorithms to anticipate trends and support strategic decisions.',
    'skill_6_title': '💡 Business Intelligence & Insights',
    'skill_6_desc': 'Creating dashboards and reports that translate data into strategy and measurable business impact.',
    'skill_7_title': '🐍 Python for Data Science',
    'skill_7_desc': 'Full stack: Pandas, NumPy, scikit-learn, TensorFlow, FastAPI, Airflow, and beyond.',
    'skill_8_title': '💾 SQL & Database Design',
    'skill_8_desc': 'Advanced queries, performance optimization, and architecting reliable data models.',
    'skill_9_title': '🔄 ETL & Data Pipelines',
    'skill_9_desc': 'Building and orchestrating automated workflows that process, validate, and transform data at scale.',
    'skill_10_title': '📈 Power BI & Looker Studio',
    'skill_10_desc': 'Designing interactive dashboards and visual stories that empower data-driven decision-making.',
    'skill_11_title': '📈 Data-Driven Decision Making',
    'skill_11_desc': 'Using data and AI insights to guide strategic business choices and measurable outcomes.',
    'skill_12_title': '💼 AI Strategy & Business Impact',
    'skill_12_desc': 'Applying artificial intelligence to solve business problems and create scalable value.',
  ...
  pt: {
    ...
    'skill_1_title': '🤖 Soluções de Dados com IA',
    'skill_1_desc': 'Combinando aprendizado de máquina, análise e automação para transformar dados brutos em sistemas inteligentes.',
    'skill_2_title': '⚙️ Engenharia de Machine Learning',
    'skill_2_desc': 'Projetando e implantando pipelines ML escaláveis, do treinamento de modelos a endpoints prontos para produção.',
    'skill_3_title': '✨ Aplicações de IA Generativa',
    'skill_3_desc': 'Construindo assistentes inteligentes com RAG, LLMs, embeddings e engenharia de prompts para resolver problemas reais.',
    'skill_4_title': '📊 Análise e Visualização de Dados',
    'skill_4_desc': 'Transformando conjuntos de dados complexos em narrativas claras e insights acionáveis com ferramentas BI modernas.',
    'skill_5_title': '🔮 Modelagem Preditiva e Forecasting',
    'skill_5_desc': 'Análise de séries temporais, modelagem estatística e algoritmos para antecipar tendências e apoiar decisões estratégicas.',
    'skill_6_title': '💡 Business Intelligence e Insights',
    'skill_6_desc': 'Criando dashboards e relatórios que traduzem dados em estratégia e impacto empresarial mensurável.',
    'skill_7_title': '🐍 Python para Ciência de Dados',
    'skill_7_desc': 'Stack completo: Pandas, NumPy, scikit-learn, TensorFlow, FastAPI, Airflow e além.',
    'skill_8_title': '💾 SQL e Design de Banco de Dados',
    'skill_8_desc': 'Consultas avançadas, otimização de desempenho e arquitetura de modelos de dados confiáveis.',
    'skill_9_title': '🔄 ETL e Pipelines de Dados',
    'skill_9_desc': 'Construindo e orquestrando fluxos de trabalho automatizados que processam, validam e transformam dados em escala.',
    'skill_10_title': '📈 Power BI e Looker Studio',
    'skill_10_desc': 'Projetando dashboards interativos e histórias visuais que capacitam a tomada de decisões baseada em dados.',
    'skill_11_title': '📈 Tomada de Decisão Orientada por Dados',
    'skill_11_desc': 'Usando insights de dados e IA para orientar escolhas estratégicas de negócios e resultados mensuráveis.',
    'skill_12_title': '💼 Estratégia de IA e Impacto Empresarial',
    'skill_12_desc': 'Aplicando inteligência artificial para resolver problemas de negócios e criar valor escalável.',
